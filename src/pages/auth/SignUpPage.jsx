  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-8">
        <div 
          className="w-full max-w-[590px] rounded-3xl"
          style={{
        ...
        >
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="relative">
                  <Building className='absolute left-3 top-1/2 transform -translate-y-1/2 h-8 w-8 text-gray-400' />
                  <input
                    id="businessName"
                    name="businessName"
                    type="text"
              ...
              <div className="space-y-2">
                <div className="relative">
                  <Mail className='absolute left-3 top-1/2 transform -translate-y-1/2 h-8 w-8 text-gray-400' />
                  <input
                    id="email"
                    name="email"
                    type="email"
              ...
              <div className="space-y-2">
                <div className="relative">
                  <Lock className='absolute left-3 top-1/2 transform -translate-y-1/2 h-8 w-8 text-gray-400' />
                  <input
                    id="password"
                    name="password"
                    ...
                    className={`w-full pl-13 h-12 placeholder:text-[#1C1C1C99] placeholder:font-normal placeholder:text-base leading-[18px] border border-gray-300 bg-[#1C1C1C0D] rounded-md px-3 py-2 focus:outline-none focus:ring-2 ${validationErrors.password ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'focus:border-orange-500 focus:ring-orange-500'}`}
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="space-y-2">
                <div className="relative">
                  <Phone className='absolute left-3 top-1/2 transform -translate-y-1/2 h-8 w-8 text-gray-400' />
                  <input
                    id="phone"
                    name="phone"
                    type="tel"
                    ...
                    className="w-full pl-13 h-12 placeholder:text-[#1C1C1C99] placeholder:font-normal placeholder:text-base leading-[18px] border border-gray-300 bg-[#1C1C1C0D] rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:border-orange-500 focus:ring-orange-500"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="relative">
                  <svg className='absolute left-3 top-1/2 transform -translate-y-1/2 h-8 w-8 text-gray-400' viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="space-y-2">
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-4 h-4 text-orange-500 bg-gray-100 border-gray-300 rounded focus:ring-orange-500 focus:ring-2 mt-1"
                  />
                  <label htmlFor="agreeToTerms" className="ml-2 text-sm text-gray-600">
                    Agree to T&Cs and privacy policy
                  </label>
                </div>
            ...
            <div className="text-center mt-6">
              ...
              <a href="/login" className="text-orange-500 hover:text-orange-600 text-sm font-medium transition-colors">
                Login
              </a>
            </div>
